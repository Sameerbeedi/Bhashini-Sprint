...
def load_emotion_data():
    df = pd.read_csv("emotion_recognition/text_emotion.csv")
    additional_anger = read_text_file("emotion_recognition/anger.txt")
    ...
    pickle.dump(vocab2int, open("emotion_recognition/vocab2int.pickle", "wb"))
