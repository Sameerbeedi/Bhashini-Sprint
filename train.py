...
#model.load_weights("emotion_recognition/model_v1_0.68_0.74.h5")
model.compile(loss="categorical_crossentropy", optimizer="rmsprop", metrics=["accuracy"])

if not os.path.isdir("results"):
    os.mkdir("results")

#checkpointer = ModelCheckpoint("emotion_recognition/model_v1_{val_loss:.2f}_{val_acc:.2f}.h5", save_best_only=True, verbose=1)
